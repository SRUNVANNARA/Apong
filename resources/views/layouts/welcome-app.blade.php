        ...
        <div id="btn" style="display: none" >
            ...
            <form action="/home" method="GET">
                ...
                <div class="text-center" style="margin-top: -270px">
                    <input type="submit" name="1" id="1" value="" class="button" style="background-color: transparent; width: 100px; height: 140px;border-radius:100px 0px 00px 40px;border-color: transparent;outline: none"/>
                    <input type="submit" name="2" id="2" value="" class="button" style="background-color: transparent; width: 40px; height: 180px;border-radius:50px 50px 00px 0px;  border-color: transparent;outline: none"/>
                    <input type="submit" name="3" id="3" value="" class="button"  style="background-color: transparent; width: 100px; height: 140px; border-radius:0px 100px 40px 0px;border-color: transparent;outline: none"/>
                </div>
            </form>
        </div>
        <div class="text-center my-5">
            <button  id="info" type="button" class="btn btn-outline-info btn-lg">{{$info}}</button>
        </div>
